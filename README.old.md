...
```sh
  cd my-folder
  git clone git@github.com:rabayarabu/Portfolio-setup-and-mobile-first.git
```
...
Feel free to check the [https://github.com/rabayarabu/Portfolio-setup-and-mobile-first/issues](../../issues/).
